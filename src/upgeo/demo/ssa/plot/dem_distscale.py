...
if __name__ == '__main__':
    ...
    covariates = [15,0,0,1,15,760] #fdepth=15,fm=ss,vs30=760
    #covariates = [15,0,0,1,15,270] #fdepth=15,fm=ss,vs30=270
    ...
    for mw in magnitudes:
        ...
        np.savetxt('/home/marcel/datasets/multilevel/nga/ssa/viz/distscale/gpselincorr_mw{0}_vs270_pred_T1.csv'.format(mw), np.c_[distances,yfit], delimiter=',')       
