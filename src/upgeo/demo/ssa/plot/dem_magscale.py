...
if __name__ == '__main__':
    ...
    n = len(magnitudes)
    covariates = [0,1,0,15,10,760] #fdepth=15,fm=ss,dist=30,vs30=760
    ...
    np.savetxt('/home/marcel/datasets/multilevel/nga/ssa/viz/distscale/fig3/rjb10/gpsecorr_pred_pga.csv', np.c_[magnitudes,yfit], delimiter=',')    
