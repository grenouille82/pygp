...
if __name__ == '__main__':
    train_fname = '/home/mhermkes/datasets/multilevel/nga/ssa/nga_ssa_train_fullperiods.csv'
    
    pred_cols = np.arange(0,9)
    #target_cols = np.arange(9,19)
    target_cols = np.arange(9,94)#for full periods


    periods = np.loadtxt('/home/mhermkes/datasets/multilevel/nga/ssa/nga_gp_periods.csv')
...
#   distances = [10,100]
    ...
    covariates = [0,1,0,15,10] #fdepth=15,fm=ss, dist=10
    
    '''
    @todo: check if the prediction works correctly for one record
    '''
    for v in vs30:
        for mw in magnitudes:
            ...
            np.savetxt('/home/mhermkes/datasets/multilevel/nga/ssa/viz/response_spectra/fit/gpselincorr_mag{0}_vs{1}_pred_spectra.csv'.format(mw,v), np.c_[periods,yfit], delimiter=',')
    ...
    #covariates = [7,15,0,1,0] #mw=7,fdepth=15,fm=ss
    #covariates = [6,15,0,1,0] #mw=7,fdepth=15,fm=ss
    covariates_rev = [1,0,0,15]
    covariates_ss = [0,1,0,15] #mw7, fdepth=15,fm=ss
    covariates_norm = [0,0,1,15]
    ...
    for v in vs30:
        for mw in magnitudes:
            for r in distances:
                ...
                np.savetxt('/home/mhermkes/datasets/multilevel/nga/ssa/viz/response_spectra/mechanism/gpselincorr_mag{0}_vs{1}_dist{2}_pred_spectra_strikeslip.csv'.format(mw,v,r), np.c_[periods,yfit_ss], delimiter=',')
                np.savetxt('/home/mhermkes/datasets/multilevel/nga/ssa/viz/response_spectra/mechanism/gpselincorr_mag{0}_vs{1}_dist{2}_pred_spectra_reverse.csv'.format(mw,v,r), np.c_[periods,yfit_rev], delimiter=',')
                np.savetxt('/home/mhermkes/datasets/multilevel/nga/ssa/viz/response_spectra/mechanism/gpselincorr_mag{0}_vs{1}_dist{2}_pred_spectra_normal.csv'.format(mw,v,r), np.c_[periods,yfit_norm], delimiter=',')
                np.savetxt('/home/mhermkes/datasets/multilevel/nga/ssa/viz/response_spectra/mechanism/gpselincorr_mag{0}_vs{1}_dist{2}_spectra_ratio_reverse_strikeslip.csv'.format(mw,v,r), np.c_[periods,yfit_ratio_rev_ss], delimiter=',')
                np.savetxt('/home/mhermkes/datasets/multilevel/nga/ssa/viz/response_spectra/mechanism/gpselincorr_mag{0}_vs{1}_dist{2}_spectra_ratio_normal_strikeslip.csv'.format(mw,v,r), np.c_[periods,yfit_ratio_norm_ss], delimiter=',')
    ...
    covariates_vs270 = [0,1,0,15,270] #fdepth=15,fm=ss, vs=270
    covariates_vs490 = [0,1,0,15,490] #fdepth=15,fm=ss, vs=490
    covariates_vs760 = [0,1,0,15,760] #fdepth=15,fm=ss, vs=760
    ...
    for mw in magnitudes:
        for r in distances:
            ...
            np.savetxt('/home/mhermkes/datasets/multilevel/nga/ssa/viz/response_spectra/vs30/gpselincorr_mag{0}_vs270_dist{1}_pred_spectra.csv'.format(mw,r), np.c_[periods,yfit_vs270], delimiter=',')
            np.savetxt('/home/mhermkes/datasets/multilevel/nga/ssa/viz/response_spectra/vs30/gpselincorr_mag{0}_vs490_dist{1}_pred_spectra.csv'.format(mw,r), np.c_[periods,yfit_vs490], delimiter=',')
            np.savetxt('/home/mhermkes/datasets/multilevel/nga/ssa/viz/response_spectra/vs30/gpselincorr_mag{0}_vs760_dist{1}_pred_spectra.csv'.format(mw,r), np.c_[periods,yfit_vs760], delimiter=',')
            np.savetxt('/home/mhermkes/datasets/multilevel/nga/ssa/viz/response_spectra/vs30/gpselincorr_mag{0}_dist{1}_spectra_ratio_vs270_vs760.csv'.format(mw,r), np.c_[periods,yfit_ratio_vs270_vs760], delimiter=',')
            np.savetxt('/home/mhermkes/datasets/multilevel/nga/ssa/viz/response_spectra/vs30/gpselincorr_mag{0}_dist{1}_spectra_ratio_vs490_vs760.csv'.format(mw,r), np.c_[periods,yfit_ratio_vs490_vs760], delimiter=',')
    ...
    '''
    np.savetxt('/home/mhermkes/datasets/multilevel/nga/ssa/viz/response_spectra/noise/gpselincorr_model_stddevs.csv', np.c_[periods,model_devs], delimiter=',')
    np.savetxt('/home/mhermkes/datasets/multilevel/nga/ssa/viz/response_spectra/noise/gpselincorr_model_within_stddevs.csv', np.c_[periods,model_intra_devs], delimiter=',')
    np.savetxt('/home/mhermkes/datasets/multilevel/nga/ssa/viz/response_spectra/noise/gpselincorr_model_between_stddevs.csv', np.c_[periods,model_inter_devs], delimiter=',')
